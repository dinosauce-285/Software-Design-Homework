...
// Import Middlewares
import { isAuthenticated, requirePermission } from "./middlewares/auth.mdw.js";
...
app.use("/admin", requirePermission(Permissions.MANAGE_USERS)); // Using MANAGE_USERS as a general admin permission limit
